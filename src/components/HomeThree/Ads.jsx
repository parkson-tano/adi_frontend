        ...
        >
          <div>
            ...
            <h1 className="md:text-[30px] text-xl font-bold text-qblack mb-1">
              Get <span className="mx-1 text-[#EB5757]"> Best Logistic Company </span>
            </h1>
            <p className="text-qgray">
              Ship your product from China to Cameroon with ease <br />
              With ADI Import Export Trading Company
            </p>
          </div>
